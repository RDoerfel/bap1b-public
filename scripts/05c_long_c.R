...
total_result <- data.table(
    ...
    cumhazard_minus_sd = numeric(),
    ci_lower_minus_sd = numeric(),
    ci_upper_minus_sd = numeric(),
    cumhazard_mu = numeric(),
    ci_lower_mu = numeric(),
    ci_upper_mu = numeric(),
    cumhazard_plus_sd = numeric(),
...
for (i in seq_along(dvs)) {
    ...
    total_result <- rbind(
        ...
        data.table(
            ...
            cumhazard_minus_sd = cox_probs$cumhazard[1, ],
            ci_lower_minus_sd = cox_probs$cumhazard.lower[1, ],
            ci_upper_minus_sd = cox_probs$cumhazard.upper[1, ],
            cumhazard_mu = cox_probs$cumhazard[2, ],
            ci_lower_mu = cox_probs$cumhazard.lower[2, ],
            ci_upper_mu = cox_probs$cumhazard.upper[2, ],
            cumhazard_plus_sd = cox_probs$cumhazard[3, ],
            ci_lower_plus_sd = cox_probs$cumhazard.lower[3, ],
            ci_upper_plus_sd = cox_probs$cumhazard.upper[3, ],
